...
public class Notification extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.notificationcolor);
    ...
    private void initUI() {
        ...
        // Khởi tạo nội dung cho các thông báo
        setupNotifications();
    }

    private void setupNotifications() {
        // Khai báo danh sách các TextView thông báo
        ...
        // Thiết lập nội dung và sự kiện click cho từng thông báo
    ...
    private void setupNotificationTextView(TextView textView, String title, String content, String time) {
        // Hiển thị nội dung gộp (có thể format lại tùy UI)
        String display = title + "\n" + content + "\n" + time;
        textView.setText(display);

        // Đảm bảo TextView có thể click được (nên đặt thêm trong XML nữa)
        textView.setClickable(true);
        textView.setFocusable(true);

        // Xử lý khi người dùng nhấn vào
        textView.setOnClickListener(v -> {
            // Ví dụ: Mở một activity chi tiết hoặc hiển thị dialog
    ...
    private void setupNotificationButton(Button button, String title, String message, String time) {
        // Cài đặt text cho button với format HTML để hiển thị nhiều dòng và styles
        ...
        button.setOnClickListener(v -> {
            ...
            button.setAlpha(0.7f); // Làm mờ thông báo đã đọc
        });
    }

    private void updateNotificationReadStatus() {
        // Danh sách các button thông báo
        ...
        // Đánh dấu tất cả là đã đọc (làm mờ)
